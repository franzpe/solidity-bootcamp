  ...
  const changeFetchMethod = e => {
    ...
    switch (e.target.value) {
      case 'wallet':
        ...
        break;
      case 'collection':
        setWalletOrCollectionAddress('0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e');
        break;
  ...
  const fetchNFTs = async pagekey => {
    ...
    try {
      const res = await fetch(endpoint, {
        method: 'POST',
        body: JSON.stringify({
          address: fetchMethod == 'connectedWallet' ? address : walletOrCollectionAddress,
          ...
          {nfts?.length && fetchMethod != 'collection' && (
            ...
            >
              ...
              <label className={styles.switch}>
                <input onChange={e => setSpamFilter(e.target.checked)} checked={spamFilter} type="checkbox" />
